...
![Atithi Hero Section](docs/screenshots/01-hero.png)

### Better Food for More People

![Order Section](docs/screenshots/02-order-section.png)

### App Features

![Atithi Features](docs/screenshots/03-features.png)

### Gold Membership

![Atithi Gold](docs/screenshots/04-gold.png)

### Download & Footer

![Download and Footer](docs/screenshots/05-download-footer.png)
...
| **react-snowfall** | Decorative snowfall effect |
